...
function setRedirectionUrl() {
    if (process.env.NODE_ENV === 'development') return "http://localhost:3000/redirection/patreon/link-account"

    return "https://findstable.netlify.app/redirection/patreon/link-account"
}
