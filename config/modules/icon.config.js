export default {
    ...
    aliases: {
        ...
        'bellEmpty': 'material-symbols:notifications-outline-rounded',
        'bellRing': 'material-symbols:notifications-active-rounded',
        'bellFull': 'material-symbols:notifications-rounded',
